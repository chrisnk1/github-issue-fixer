...
export default function SessionPage() {
    ...
    const statusConfig = {
        analyzing: { color: 'hsl(250, 95%, 65%)', label: 'Analyzing' },
        planning: { color: 'hsl(280, 85%, 65%)', label: 'Planning' },
        executing: { color: 'hsl(40, 95%, 60%)', label: 'Executing' },
        complete: { color: 'hsl(140, 70%, 55%)', label: 'Complete' },
        error: { color: 'hsl(0, 85%, 60%)', label: 'Error' }
    };
    ...
    return (
        <div className="session-container">
            {/* Header */}
            <header className="session-header glass-card">
                <div className="session-header-content">
                    <div className="session-title-row">
                        <div className="session-id-badge glass-card">
                        ...
                        <a
                            ...
                            className="issue-link glass-card"
                        >
                    ...
                    <div className="progress-bar-container">
                        <div
                            ...
                            style={{
                                ...
                                background: `linear-gradient(90deg, ${currentStatus.color}, hsl(320, 85%, 60%))`
                            }}
                        ></div>
                    </div>
                </div>
            ...
            <main className="session-main">
                ...
                {session.status === 'analyzing' && (
                    <section className="session-section glass-card">
                        <div className="section-header">
                            <div className="section-icon">🔍</div>
                            <h2 className="section-title">Analyzing Repository</h2>
                        </div>
                        <div className="analysis-steps">
                            {['Cloning repository', 'Installing dependencies', 'Running tests', 'Generating architecture'].map((step, i) => (
                    ...
                    <section className="session-section glass-card">
                        ...
                        <div className="plan-steps">
                            {session.plan.steps.map((step, i) => (
                                <div key={i} className={`plan-step glass-card ${step.status || 'pending'}`}>
                ...
                {session.status === 'complete' && (
                    <section className="session-section glass-card complete">
                        <div className="section-header">
                            <div className="section-icon">✅</div>
                            <h2 className="section-title">Complete</h2>
                        </div>
                        <p className="completion-message">All changes have been successfully applied.</p>
                        <div className="completion-actions">
                            <button className="btn btn-primary">Create Pull Request</button>
                            <button className="btn btn-glass">Export Patch</button>
                        </div>
                    </section>
                )}
                ...
                {session.status === 'error' && (
                    <section className="session-section glass-card error">
                        <div className="section-header">
